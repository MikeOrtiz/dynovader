...
<div>
	...
	<form name="bingfrm" method="post" action="../tests/BingMapsSDKTest.php">
	<div class="left" style="float: left; width: 285px;">
		...
		<div style="height: 30px;"><input type="button" id="showDirection" value="Show Direction" onclick="<?php $bingObj->showDirections('mangalore, india', 'hubli, india');?>"/></div>
