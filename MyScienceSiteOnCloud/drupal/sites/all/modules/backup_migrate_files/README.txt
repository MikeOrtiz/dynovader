...
* NB: if you are doing scheduled backups of both db and files, you should create a
  separate destination for each, specifing unique directories. Otherwise you'll get
  problems retaining the correct number of backups.
